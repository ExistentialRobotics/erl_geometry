...
TEST(IntersectionLineEllipse, OneIntersection) {
    ...
    erl::geometry::ComputeIntersectionBetweenLineAndEllipse2D(-3, 1, 3, 1, 2, 1, lam1, lam2, intersected);
...
TEST(IntersectionLineEllipse, TwoIntersections) {
    ...
    erl::geometry::ComputeIntersectionBetweenLineAndEllipse2D(-3, 0, 3, 0, 2, 1, lam1, lam2, intersected);
    EXPECT_TRUE(intersected);
...
TEST(IntersectionLineEllipse, NoIntersection) {
    ...
    erl::geometry::ComputeIntersectionBetweenLineAndEllipse2D(-3, 1.1, 3, 1, 2, 1, lam1, lam2, intersected);
