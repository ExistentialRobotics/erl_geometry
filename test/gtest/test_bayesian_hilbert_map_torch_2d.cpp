...
TEST(BayesianHilbertMap, Torch2Dd) {
    TestImpl2D<double>(
...
TEST(BayesianHilbertMap, Torch2Df) {
    TestImpl2D<float>(
        g_options.hinged_grid_size,
        g_options.max_dataset_size,
        g_options.test_grid_size,
