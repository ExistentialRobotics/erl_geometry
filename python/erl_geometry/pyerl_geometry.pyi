...
class AbstractQuadtree:
    ...
    class QuadtreeNodeIterator:
        ...
        @property
        def node(self) -> AbstractOctreeNode: ...

    def get_leaf_iterator(self) -> QuadtreeNodeIterator: ...
    def get_leaf_in_aabb_iterator(self, aabb: Aabb2D, max_depth: int) -> QuadtreeNodeIterator: ...
    def get_tree_iterator(self, max_depth: int) -> QuadtreeNodeIterator: ...
    def get_tree_in_aabb_iterator(self, aabb: Aabb3D, max_depth: int) -> QuadtreeNodeIterator: ...
