...
class Lidar2DFrame:
    ...
    @property
    def num_angles(self: Lidar2DFrame) -> int: ...
    @property
    def translation(self: Lidar2DFrame) -> npt.NDArray[np.float64]: ...
    @property
    def rotation(self: Lidar2DFrame) -> npt.NDArray[np.float64]: ...
    @property
    def pose(self: Lidar2DFrame) -> npt.NDArray[np.float64]: ...
    @property
    def ray_directions(self: Lidar2DFrame) -> npt.NDArray[np.float64]: ...
    @property
    def oriented_ray_directions(self: Lidar2DFrame) -> npt.NDArray[np.float64]: ...
    @property
    def ray_end_points_in_body_frame(self: Lidar2DFrame) -> npt.NDArray[np.float64]: ...
    @property
    def ray_end_points_in_world_frame(self: Lidar2DFrame) -> npt.NDArray[np.float64]: ...
