...
BindOccupancyNdTreeSetting(const py::module &m) {
    ...
    py::class_<OccupancyNdTreeSetting, NdTreeSetting, std::shared_ptr<OccupancyNdTreeSetting>>(
        m,
        ...
        .def_property(
            "probability_hit",
            &OccupancyNdTreeSetting::GetProbabilityHit,
            &OccupancyNdTreeSetting::SetProbabilityHit)
        .def_property(
            "probability_miss",
            &OccupancyNdTreeSetting::GetProbabilityMiss,
            &OccupancyNdTreeSetting::SetProbabilityMiss)
        .def_property(
