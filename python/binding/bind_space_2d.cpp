...
BindSpace2D(const py::module &m) {
    ...
    py_space
        .def(
            py::init<
                const std::vector<Eigen::Ref<const Eigen::Matrix2Xd>> &,
                const std::vector<Eigen::Ref<const Eigen::Matrix2Xd>> &>(),
        ...
        .def(
            "generate_map_image",
            &Space2D::GenerateMapImage,
            py::arg("grid_map_info"),
            py::arg("anti_aliased") = false)
        .def(
            "compute_sdf_image",
        ...
        .def(
            ...
            py::call_guard<py::gil_scoped_release>())
        .def(
            "compute_sdf_with_kdtree",
            &Space2D::ComputeSdfWithKdtree,
            py::arg("q"),
            py::arg("sign_method"))
        .def(
            "compute_sdf_greedily",
                ...
                for (long i = 0; i < n_rows; i++) {
                    for (long j = 0; j < n_cols; j++) {
                        for (long k = 0; k < n_dirs; k++) {
                            out.mutable_at(i, j, k) = result(i, j)[k];
                        }
                    }
                }
                return out;
        ...
        .def(
            ...
            py::overload_cast<
                ...
                const Eigen::Ref<const Eigen::Matrix2Xd> &,
                bool>(&Space2D::ComputeDdf, py::const_),
            py::arg("query_points"),
            py::arg("query_directions"),
            py::arg("parallel") = false,
            py::call_guard<py::gil_scoped_release>())
        ...
        .def(
            ...
            py::overload_cast<
                const Eigen::Ref<const Eigen::Matrix2Xd> &,
                const Eigen::Ref<const Eigen::Matrix2Xd> &,
                bool>(&Space2D::ComputeSddfV1, py::const_),
            py::arg("query_points"),
            py::arg("query_directions"),
            py::arg("parallel") = false,
            py::call_guard<py::gil_scoped_release>())
        .def(
            ...
            [](const Space2D &space,
               ...
               const bool parallel) {
                auto result =
                    space.ComputeSddfV2(grid_map_info, query_directions, sign_method, parallel);
                const long n_rows = result.rows();
                const long n_cols = result.cols();
                const long n_dirs = query_directions.cols();
                py::array_t<double> out({n_rows, n_cols, n_dirs});
        ...
        .def(
            ...
            py::overload_cast<
                ...
                const Eigen::Ref<const Eigen::Matrix2Xd> &,
                Space2D::SignMethod,
                bool>(&Space2D::ComputeSddfV2, py::const_),
            py::arg("query_points"),
            py::arg("query_directions"),
            py::arg("sign_method") = Space2D::SignMethod::kLineNormal,
            py::arg("parallel") = false,
