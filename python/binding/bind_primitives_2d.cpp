...
BindPrimitives2D(const py::module &m) {
    ...
    primitive.def_readwrite("id", &Primitive2D::id)
        ...
        .def(
            ...
            py::overload_cast<const Line2D &>(&Primitive2D::ComputeIntersections, py::const_),
            py::arg("line"))
        .def(
            "compute_intersections",
            py::overload_cast<const Segment2D &>(&Primitive2D::ComputeIntersections, py::const_),
            py::arg("segment"))
        .def(
            "compute_intersections",
            py::overload_cast<const Ray2D &>(&Primitive2D::ComputeIntersections, py::const_),
            py::arg("ray"))
        .def_property_readonly("orientation_angle", &Primitive2D::GetOrientationAngle);

    py::class_<Line2D, Primitive2D>(m, "Line2D")
        .def(
            py::init<int, Eigen::Vector2d, Eigen::Vector2d>(),
            py::arg("id"),
            py::arg("p0"),
            py::arg("p1"))
        .def_readwrite("p0", &Line2D::p0)
        .def_readwrite("p1", &Line2D::p1);
    py::class_<Segment2D, Line2D>(m, "Segment2D")
        .def(
            py::init<int, Eigen::Vector2d, Eigen::Vector2d>(),
            py::arg("id"),
            py::arg("p0"),
    ...
    py::class_<AxisAlignedRectangle2D, Primitive2D, Aabb2Dd>(m, "AxisAlignedRectangle2D")
        .def(
            py::init<int, const Eigen::Vector2d &, const Eigen::Vector2d &>(),
            py::arg("id"),
            py::arg("center"),
            py::arg("half_sizes"));
    py::class_<Rectangle2D, Primitive2D>(m, "Rectangle2D")
        .def(
            py::init<int, Eigen::Vector2d, Eigen::Vector2d, double>(),
            py::arg("id"),
            py::arg("center"),
            py::arg("half_sizes"),
            py::arg("angle"))
        ...
        .def_property(
            "orientation_angle",
            &Rectangle2D::GetOrientationAngle,
            &Rectangle2D::SetOrientationAngle)
        .def(
            "compute_points_on_boundary",
            &Rectangle2D::ComputePointsOnBoundary,
            py::arg("num_points"));
    py::class_<Ellipse2D, Primitive2D>(m, "Ellipse2D")
        .def(
            py::init<int, Eigen::Vector2d, double, double, double>(),
            py::arg("id"),
            py::arg("center"),
            py::arg("a"),
            py::arg("b"),
        ...
        .def_property(
            "orientation_angle",
            &Ellipse2D::GetOrientationAngle,
            &Ellipse2D::SetOrientationAngle)
        .def(
            "compute_points_on_boundary",
