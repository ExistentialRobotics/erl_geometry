...
BindLidarFrame2DImpl(const py::module &m, const char *name) {
    ...
    lidar_frame_2d.def(py::init<std::shared_ptr<typename Frame::Setting>>(), py::arg("setting"))
        ...
        .def("world_to_frame_so2", &Frame::WorldToFrameSo2, py::arg("dir_world"))
        .def("frame_to_world_so2", &Frame::FrameToWorldSo2, py::arg("dir_frame"))
        .def("world_to_frame_se2", &Frame::WorldToFrameSe2, py::arg("xy_world"))
        .def("frame_to_world_se2", &Frame::FrameToWorldSe2, py::arg("xy_frame"))
