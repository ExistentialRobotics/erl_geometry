#include "erl_geometry/ros/ros2/rviz_plugin/occupancy_tree_grid_display.hpp"
...
namespace erl::geometry::rviz_plugin {
    ...
    OccupancyTreeGridDisplay::OccupancyTreeGridDisplay()
        : rviz_common::MessageFilterDisplay<erl_geometry::msg::OccupancyTreeMsg>(),
    ...
    OccupancyTreeGridDisplay::processMessage(
        erl_geometry::msg::OccupancyTreeMsg::ConstSharedPtr msg) {
        if (msg->dim == 2) {
            if (msg->is_double) {
