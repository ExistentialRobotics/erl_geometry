...
BindOccupancyQuadtree(
    ...
    std::function<void(py::class_<Quadtree, erl::geometry::AbstractOccupancyQuadtree<typename Quadtree::DataType>, std::shared_ptr<Quadtree>>&)>
        additional_bindings = nullptr) {
    ...
    py::class_<Quadtree, AbstractOccupancyQuadtree<typename Quadtree::DataType>, std::shared_ptr<Quadtree>> tree(m, tree_name);
    ...
    tree.def(py::init<>())
        ...
        .def(
            "cast_ray",
            [](const Quadtree& self, Dtype px, Dtype py, Dtype vx, Dtype vy, bool ignore_unknown, Dtype max_range) {
                Dtype ex, ey;
    ...
    tree.def_property_readonly("number_of_nodes", &Quadtree::GetSize)
        ...
        .def("coord_to_key", py::overload_cast<Dtype>(&Quadtree::CoordToKey, py::const_), py::arg("coordinate"))
        .def("coord_to_key", py::overload_cast<Dtype, uint32_t>(&Quadtree::CoordToKey, py::const_), py::arg("coordinate"), py::arg("depth"))
        .def("coord_to_key", py::overload_cast<Dtype, Dtype>(&Quadtree::CoordToKey, py::const_), py::arg("x"), py::arg("y"))
        .def("coord_to_key", py::overload_cast<Dtype, Dtype, uint32_t>(&Quadtree::CoordToKey, py::const_), py::arg("x"), py::arg("y"), py::arg("depth"))
        .def(
        ...
        .def(
            "compute_ray_coords",
            [](const Quadtree& self, Dtype sx, Dtype sy, Dtype ex, Dtype ey) {
                if (std::vector<Vector2> ray; self.ComputeRayCoords(sx, sy, ex, ey, ray)) { return std::optional<std::vector<Vector2>>(ray); }
        ...
        .def("delete_node", py::overload_cast<Dtype, Dtype, uint32_t>(&Quadtree::DeleteNode), py::arg("x"), py::arg("y"), py::arg("depth"))
        ...
        .def("search", py::overload_cast<Dtype, Dtype, uint32_t>(&Quadtree::Search, py::const_), py::arg("x"), py::arg("y"), py::arg("max_depth") = 0)
        .def("search", py::overload_cast<const QuadtreeKey&, uint32_t>(&Quadtree::Search, py::const_), py::arg("key"), py::arg("max_depth") = 0)
        .def("insert_node", py::overload_cast<Dtype, Dtype, uint32_t>(&Quadtree::InsertNode), py::arg("x"), py::arg("y"), py::arg("depth"))
        ...
        .def(
            ...
            [](std::shared_ptr<Quadtree>& self,
               ...
               std::optional<Vector2> area_min,
               std::optional<Vector2> area_max,
    ...
    py::class_<typename Quadtree::IteratorBase, typename AbstractQuadtree<typename Quadtree::DataType>::QuadtreeNodeIterator>(tree, "IteratorBase")
    ...
    tree.def(
        ...
        .def(
            "iter_leaf_in_aabb",
            [](Quadtree& self, const Dtype aabb_min_x, const Dtype aabb_min_y, const Dtype aabb_max_x, const Dtype aabb_max_y, const uint32_t max_depth) {
