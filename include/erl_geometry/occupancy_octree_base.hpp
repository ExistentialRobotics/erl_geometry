...
namespace erl::geometry {
    ...
    public:
         ...
         */
        virtual bool
        InsertRay(Dtype sx, Dtype sy, Dtype sz, Dtype ex, Dtype ey, Dtype ez, Dtype max_range, bool lazy_eval);
         ...
         */
        const Node*
        CastRay(Dtype px, Dtype py, Dtype pz, Dtype vx, Dtype vy, Dtype vz, bool ignore_unknown, Dtype max_range, Dtype& ex, Dtype& ey, Dtype& ez) const;
    ...
    private:
        Node*
        UpdateNodeRecurs(Node* node, bool node_just_created, const OctreeKey& key, Dtype log_odds_delta, bool lazy_eval);
