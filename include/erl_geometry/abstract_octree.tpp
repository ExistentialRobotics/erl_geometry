...
namespace erl::geometry {
    ...
    std::enable_if_t<std::is_base_of_v<AbstractOctree<Dtype>, Derived>, bool>
    AbstractOctree<Dtype>::Register(const std::string &tree_type) {
    ...
    template<typename T>
    std::shared_ptr<T>
    AbstractOctree<Dtype>::GetSetting() const {
